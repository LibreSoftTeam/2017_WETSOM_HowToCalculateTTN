...
On the other hand, Figure~\ref{fig:graph1} shows how the variables are related each other in ElasticSearch. In this project, it is difficult to notice the how closely the variables are related, the percentage value of the coefficient $R^2$ in each scatterplot is lower than 9\%. 
