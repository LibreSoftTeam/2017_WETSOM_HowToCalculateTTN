...
On the other hand, Figure~\ref{fig:graph1} shows how the variables are related each other in ElasticSearch. In this project, it is more difficult to notice the negative inclination in the graph comparing TTN with EuBIC but, although the correlations matrix showed a very weak value for this comparison in this project, we may suspect the small tendency in the graph. On the contrary, the plot for TTN or EuBIC against TTF does not indicate such tendency.\grex{Sigo sin enterarme...}
...
We want to express our gratitude to Bitergia\footnote{\url{http://bitergia.com/}} for their open source tools to mine the repositories of the projects, and the support they have provided when questions have arisen. Also, we acknowledge the Spanish Government, through project TIN2014-59400-R.
