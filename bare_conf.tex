...
\gema{Review 1 said that we should clarify how important are RQ1 and RQ2 for researchers and practitioners----- Done in the above paragraph!!------------ } \grex{I think the reviewer is asking for takeaways, on a much more higher level. What you've done is rephrasing the RQs}
...
Another future line could be to perform a detailed research on how this metric could be helpful in defect prediction filed, building new models or improving them. \grex{defect prediction filed?}
