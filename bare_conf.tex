...
\gema{Review 1 said that we should clarify how important are RQ1 and RQ2 for researchers and practitioners----- Done in the above paragraph!!------------ }
...
Our study shows negative correlation between the TTN and EuBIC, which shows that the time to notify the error is related to the overall experience of the author.  
